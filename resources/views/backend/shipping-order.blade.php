...
@section('title', 'All Shipping Orders')
    ...
    <div class="row page-titles mx-0">
        <div class="col p-md-0">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="{{ route('order.shipping') }}">Shipping Order</a></li>
            </ol>
        </div>
    </div>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Customer Shipping Orders: <span class="badge bg-dark">{{ count($orders) }}</span></h4>
