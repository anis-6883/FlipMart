...
<div class="content-body">
    ...
    <div class="row page-titles mx-0">
        <div class="col p-md-0">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ route('coupon.index') }}">Manage Product Images</a></li>
                <li class="breadcrumb-item active"><a href="{{ route('coupon.create') }}">Add Product Images</a></li>
            </ol>
        </div>
    </div>
                                    ...
                                    @foreach ($products as $product)
                                        <tr>
                                            ...
                                            <form action="{{ route('product-images.store') }}" method="POST" enctype="multipart/form-data">
                                                ...
                                                <td>
                                                    <button name="save_product_images" type="submit" class="btn btn-primary">Submit</button>
